...
const Merit4 = () => {
    ...
    return (
        <div className='container'>
            <div className='p-[2px] bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 rounded-lg'>
                <div className='flex flex-col gap-6 bg-black rounded-lg p-4'>
                    {' '}
                    <span className='text-4xl text-green-400 to-blue-500 font-bold px-4 py-2 rounded-lg mt-2 text-center'>
                        広告インセンティブ
                    </span>
